...
//    public Zglaszaj() throws SimControlException {
//        super();
//        generator = new SimGenerator();
//    }
	...
	protected void stateChange() throws SimControlException {
        ...
        System.out.println(simTime()+" - "+simHour()+" - "+simMinute()+" - "+simSecond()+" - "+simMillisecond()+": Otoczenie- Dodano nowe zgl. nr: " + zgl.getTenNr());
